...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Ethix-MD&hCJnrEkM",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "✪⏤͟͞★⃝ꪶ‎𝗥𝗔𝗛𝗨𝗟-𝞛𝘿𖥘✪͜͡➺",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "94751607078",
